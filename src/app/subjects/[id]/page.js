...
const Subject = (props) => {  
  ...
  return (
    <>
    <div className="bg-white transition-d border-l-4  shadow-md rounded-xl border-blue-500 p-1 m-2 max-w-md">
      <div className="m-2">
    ...
    <div className="bg-white transition-d shadow-md rounded-xl border-blue-500 p-2 m-3 ">
        ...
        {subject.chapiters.map(chapiter => ( 
              <div className='border border-blue-400 p-5 rounded-md m-2 grid grid-rows-2 align-middle  justify-center'>
                  <h2 className='text-red-300 text-2xl font-semibold'>{chapiter.title} : </h2>
                  
                  <div className="flex items-center mt-2  mx-2">
                    <div className="w-44 h-1 bg-blue-200 rounded-full">
                      <div
                        className="bg-blue-500 h-full rounded-full"
                        style={{ width: `${subject.progress}%` }}
                      ></div>
                    </div>
                    <span className="ml-2">{chapiter.progress } %</span>
                  </div>
