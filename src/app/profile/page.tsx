...
export default function Profile() {
    ...
    const [editedLevel, setEditedLevel] = useState('edit division');
    const [levels, setLevels] = useState([{id : '' ,level : ''}]);
    ...
    return ( 
                <div
                    ...
                    <div className="p-4   flex justify-around   items-center ">
                         <Link  href='/edit_profile' className="rounded-xl bg-gray-600  p-2 text-white px-4">edit profile </Link >
                        <Link  href='/change_password' className="rounded-xl bg-gray-600  p-2 text-white px-4">change password  </Link >
